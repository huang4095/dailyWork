...
{
    //设置图形字体
    setIcon(QUIWidget::Lab_Ico, QUIConfig::IconMain, 14);
...
QUIDateSelect *QUIDateSelect::self = 0;
...
QString QUIHelper::floatToQString(float ffloat)
{
    QString temp = QString("%1").arg(ffloat);
    return temp;
}
